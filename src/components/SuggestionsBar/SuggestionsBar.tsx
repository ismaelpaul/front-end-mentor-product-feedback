...
const SuggestionsBar = () => {
	...
	return (
		<div>
			...
			<div className="text-white text-subtitleMobile font-jost h-14 bg-dark-grey-blue flex items-center justify-between pl-6 pr-6 tablet:h-72px tablet:justify-normal tablet:rounded-lg tablet:gap-38px tablet:pr-2">
